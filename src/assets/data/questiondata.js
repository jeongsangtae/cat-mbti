export const QuestionData = [
  ...
  },
  {
    ...
    answera:
      "'냥냥이 너무 이쁜 것 같아.. 사람들한테 자랑해야지!'하며 인스타를 만들어서 사진도 공유하고 소통도 한다.",
  ...
  },
  {
    id: 5,
    title:
      "고양이에 대해서 모르는 부분을 검색 하고 있다. 내가 글을 읽는 방법은?",
  ...
  },
  {
    ...
    answera: "칼로리를 정확히 맞춰 저울이나 스푼으로 개량해서 급여한다.",
    answerb: "손, 눈대중으로 대충 이정도면 되겠지 하고 급여한다.",
    type: "SN", // 체크
  },
  {
    id: 7,
    title: "같은 집사 친구의 고양이가 아픈 것 같아 슬퍼하고있다. 나의 반응은?",
    answera:
      "'이건 이렇게 하면 어떨까?' 해결책을 함께 생각하며 정보들을 같이 찾아본다.",
  ...
  },
  {
    ...
    answerb:
      "나의 의견이 상대방을 기분 나쁘게 하지않도록 잘 전달하려고 먼저 생각한다.",
    type: "TF",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    answera:
      "우리 고양이 몸무게는 5키로니까 하루 세번 몇시에 이만큼 씩 주고, 간식은 이때 챙겨줘야겠다. 영양제도 미리미리 챙겨준다.",
  ...
  },
  {
    ...
    answera:
      "사료를 조금씩 급여해서 고양이의 기호를 테스트 해보고 다 잘먹는다면 날짜에 맞춰서 질리지 않도록 바꿔가며 준다.",
