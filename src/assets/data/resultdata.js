...
export const ResultData = [
  ...
  },
  {
    ...
    name: "아메리칸 숏헤어",
    best: "INFP",
    desc: "주인에 대한 호기심이 높고 애교가 굉장히 많아요! 다만! '집사 내꺼야!' 하는 독점욕도 굉장히 강합니다. 이미 여러마리의 고양이를 키우는 집사라면 다른 고양이들에게 하악질 하는 걸 볼 수도..",
    image: `${Ameshort}`,
  },
  {
    id: 9,
    name: "코리안 숏헤어",
    best: "ISFP",
    desc: "많은 고양이의 혈통이 섞여있는 고양이에요! 대부분 활발하고 쾌활한 성격을 가지고 있고, 친밀하고 영리합니다! 사냥본능이 매우 뛰어나서 사냥놀이를 굉장히 좋아해요.",
    image: `${Korshort}`,
  },
  {
    id: 10,
    name: "엑죠틱",
    best: "ISFJ",
    desc: "낯을 가리지 않고, 주인 옆에서 느긋하게 일상을 즐기는 고양이에요! 다만 운동량이 그렇게 많지 않아 뚱냥이가 될 수 있으니 조심하기!",
    image: `${Exotic}`,
  },
  {
    id: 11,
